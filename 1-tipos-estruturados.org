...
podemos alocar somente quando necessário a estrutura através do vetor de ponteiros de estruturas. Além disso tudo,
podemos liberar a memória quando for necessário.
